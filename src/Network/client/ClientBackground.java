...
public class ClientBackground {
    ...
    private ClientGui gui;      //사용자 Gui
    private String msg;         //보낼 문자열 메세지
    private String nickName;    //사용자 이름(아이디 비번 받을 때 사용하면 좋을듯?), 맵 받을 때 엮버려도 되려나?

    public final void setGui(ClientGui gui) {   //객체의 gui 받는다.
        this.gui = gui;
    }
